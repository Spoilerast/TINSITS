...
internal abstract class Preview : InteractableObject
{
	...
	internal PreviewId Id { get; set; }

	private void Awake() { Initialize(); }

	private void OnMouseDown() { ChangePreviewMaterial(PreviewState.Active); }

	private void OnMouseEnter() { ChangePreviewMaterial(PreviewState.Hover); }

	private void OnMouseExit() { ChangePreviewMaterial(PreviewState.Default); }
