...
internal class SceneObjectsSpawner : SceneSystem
{
	...
	public bool InSpawnMode { get; private set; }
	...
	{
		Prism unit = teamId.Equals(1) //todo remade
			? _unitT1
			: _unitT2;
	...
	private static IEnumerable<GridPoint> GetDirectionsForAllSpawnPoints()
	{
		...
		return SpawnPointsProcessor.FreeSpawnPointsForTeam(team);
	}

	private void InstantiateNests()
	{
		foreach (GridPoint point in GetDirectionsForAllSpawnPoints())
			SpamnNestAt(point);
	}
