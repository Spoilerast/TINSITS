...
internal sealed class TeamId : IEquatable<TeamId>, IEquatable<byte>
{
	...
	private TeamId(byte value) { Value = value; }

	internal static TeamId NAT => new(42);

	internal bool IsNAT => _cache.ContainsKey(Value);
	...
	public bool Equals(TeamId other)
		=> Value == other!.Value; //potential null reference
	...
	public static bool operator==(TeamId left, TeamId right)
		=> left!.Equals(right); //potential null reference
