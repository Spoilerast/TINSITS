...
internal sealed class ClusterInfo
{
	...
	public ClusterInfo(GridPoint axisPoint, ClusterType clusterType, PrismType prismType, IEnumerable<GridPoint> positions)
		: this(axisPoint, clusterType, positions)
	{
		PrismType = prismType;
	}
	...
	private ClusterInfo(GridPoint axisPoint, ClusterType clusterType, IEnumerable<GridPoint> positions)
	{
		(AxisPoint, ClusterType, Positions) = (axisPoint, clusterType, positions.CastToArray());
	}
