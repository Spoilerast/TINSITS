...
{
internal abstract partial class ConnectionProcessor : Processor
{
											  ...
											  out IEnumerable<(UnitId, GridPoint)> connections)
	{
		...
		foreach (GridPoint direction in Constants.GetMoveDirectionPoints(unitPosition))
	...
	private static bool DirectionHaveUnitOrSourceInSameTeam(UnitId unitId, GridPoint direction, out UnitId neighborId)
	{
	...
	private static Connectability DirectionValidForLongConnection(UnitId unitId,
																  GridPoint direction,
	...
	private static Connectability DirectionValidForLongestConnection(UnitId unitId,
																	 GridPoint direction,
																	 out UnitId neighborId)
	{
		Connectability ability = CheckConnectability(unitId, direction, out neighborId);
